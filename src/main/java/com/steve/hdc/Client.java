    ...
    public static String signup(String user, String pass) {
        ...
        try {
            ...
            switch(response) {
                ...
                case 201:   System.err.println("Client: Successfully signed up.");
                            break;

                //If password was not up to standard, a 409 is passed.
                case 409:   System.err.println("Client: Error signing up.");
                ...
                case 406:   System.err.println("Client: Error signing up.");
                            System.err.println("        " + con.getResponseMessage());
                            result = new String("Duplicate/Invalid Username.");
                            break;

                //In all the other cases, it's just a bad request.
                default:    System.err.println("Client: Error signing up.");
                            System.err.println("        " + con.getResponseMessage());
    ...
    public static String sendMsg(String user, String pass, Message msg) {
        ...
        try {
            ...
            switch(response) {
                ...
                case 201:   System.err.println("Client: Message Successfully Sent.");
                            break;
                ...
                case 406:   System.err.println("Client: Bad Message Was Sent.");
                            System.err.println("        " + con.getResponseMessage());
                            result = new String("Invalid Sender/Recipient.");
                            break;

                //If a bad request was made.
                default:    System.err.println("Client: Error Sending Message.");
                            System.err.println("        " + con.getResponseMessage());
                            result = new String("Bad Request.");
                            break;
            }
    ...
    public static Message[] getMsg(String user, String pass, long timeFrom) {
        ...
        try {
            ...
            switch(response) {
                ...
                case 200:   System.err.println("Client: Message Successfully Recieved.");
    ...
    public static Message getFile(String user, String pass, String fileName) {
        ...
        try {
            ...
            switch(response) {
                ...
                //When anything else is sent, print the error.
                default:    System.err.println("Client: Error Recieving File.");
                            System.err.println("        " + con.getResponseMessage());
                            break;
            }
